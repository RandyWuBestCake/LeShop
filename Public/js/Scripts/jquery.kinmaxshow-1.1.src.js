	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'8px',height:'8px',lineHeight:'8px',left:'50%',bottom:'10px',fontSize:'10px',background:"url(shijie/images/banner_dian.png) no-repeat left bottom;",textAlign:'center',margin:'0 5px',fontFamily:"Verdana",float:'left'},
								//当前 按钮样式
								focus:{background:"url(shijie/images/banner_dian.png) no-repeat left top;"}
							},
			...
			k.setLayout = function(){
				...
				if(options.button.normal.display!='none'){
					...
					var dianWidth = k.size*18,
						marginLeft = -dianWidth/2;			
					$(k.self).append('<ul style="width:'+dianWidth+'px;margin-left:'+ marginLeft +'px" class="'+k.prename+'button">'+button_list+'</ul>');
