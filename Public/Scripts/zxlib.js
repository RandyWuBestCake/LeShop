        ...
        if ("1" == a.status) {
            ...
            if(actType == "parabola"){
                ...
                pop('<div style="width:402px; height:150px; overflow:hidden; background:#fff; border:1px solid;">' +
                    ...
                    '<div class="mt20 t_c">' +
                    '<a class="inline_block red_bt_m mr40" target="_blank" href=""><span class="dark">去购物车结算</span></a>' +
    ...
    e.Js.login = {
        ...
        showDialog : function (a, b) {
            ...
            if ($("#login_iframe").length == 0) {
                $("body").append(Js.Tools.getShadeLayer("login") + '<div id="login_iframe" class="login" style="z-index:1000;position:absolute;top:0;left:0;"><a id="loginClose" class="pop_head_btn_close" >x</a><iframe id="frame" scrolling="no" src="/object/index.php/Home/Login/index.html?next_action=http://' +
        ...
        logout : function (a) {
            ...
            $("body").append('<iframe id="logoutFrame" src="/object/index.php/Home/Login/logout.html?next_action=http://' + location.host + '/logoutBack.html" width=1 height=1 frameborder=0></iframe>')
        }
    };
