...
<div id="mws-wrapper">
    ...
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span><i class="icon-table"></i>订单评价列表</span>
        </div>
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <tr role="row">
                        <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            aria-label="Rendering engine: activate to sort column descending">评价ID
                        </th>
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 177px;"
                            aria-label="Platform(s): activate to sort column ascending">订单用户名
                        </th>
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 177px;" aria-label="Platform(s): activate to sort column ascending">评价内容</th> -->
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 177px;"
                            aria-label="Platform(s): activate to sort column ascending">评价等级
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 87px;"
                            aria-label="CSS grade: activate to sort column ascending">评价时间
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 87px;"
                    ...
                    <?php if(is_array($infos)): foreach($infos as $key=>$vo): ?><tr class="<?php echo $key%2==0 ? " odd
                        " :"even"; ?>">
                    ...
                    <option value="0"<?php if(($vo["order_status"]) == "0"): ?>selected ="selected"<?php endif; ?>>请选择</option>
                    <option value="1" <?php if(($vo["order_status"]) == "1"): ?>selected ="selected"<?php endif; ?>>提交订单</option>
                    <option value="2" <?php if(($vo["order_status"]) == "2"): ?>selected ="selected"<?php endif; ?>>付款成功</option>
                    <option value="3" <?php if(($vo["order_status"]) == "3"): ?>selected ="selected"<?php endif; ?>>商品生产</option>
                    <option value="4" <?php if(($vo["order_status"]) == "4"): ?>selected ="selected"<?php endif; ?>>商品配货</option>
                    <option value="5" <?php if(($vo["order_status"]) == "5"): ?>selected ="selected"<?php endif; ?>>商品出库</option>
                    <option value="6" <?php if(($vo["order_status"]) == "6"): ?>selected ="selected"<?php endif; ?>>等待收货</option>
                    <option value="7" <?php if(($vo["order_status"]) == "7"): ?>selected ="selected"<?php endif; ?>>完成</option>
                         </select>
                        </td> -->
                        <td class=" "><?php echo ($vo["username"]); ?></td>
                        <td class=" "><?php echo ($vo["grade"]); ?></td>
                        <td class=" "><?php echo ($vo["ass_time"]); ?></td>
                        <td class=" ">
                            <a class="icon-attach" href="<?php echo U('Goodsassess/edit',array('id'=>$vo['id']));?>"><i
