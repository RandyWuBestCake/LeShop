        ...
        <div class="mws-panel-body no-padding">
            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><tr class="<?php echo $key%2==0 ? " odd
                        " :"even"; ?>">

                        <td class=""><?php echo ($vo["id"]); ?></td>
                        <td class=""><?php echo ($vo["name"]); ?></td>
                        <!-- 使用变量调节器来获取数据库内容 -->
                        <td class=""><?php echo (getcatename($vo["pid"])); ?></td>
                        <td class=" "><?php echo ($vo["paths"]); ?></td>
                        <td class=" "><img src="/object<?php echo ($vo["img"]); ?>" alt="" style="width:150px;height:100px;"></td>
                        <td class=" ">
                            <a class="btn btn-small" href="<?php echo U('Cate/edit',array('id'=>$vo['id']));?>"><i
                                    class="icon-pencil"></i></a>
                            <a class="btn btn-small" href="<?php echo U('Cate/delete',array('id'=>$vo['id']));?>"><i
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('select').change(function () {
                var num = $(this).val();
                $.get('/object/index.php/Admin/Cate/changeNum', {num: num}, function () {
                    location.href = '/object/index.php/Admin/Cate/index';
                });
            })
