...
<div id="mws-wrapper">
    ...
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span><i class="icon-table"></i>配件列表</span>
        </div>
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <tr role="row">
                        <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            aria-label="Rendering engine: activate to sort column descending">配件ID
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 189px;"
                            aria-label="Browser: activate to sort column ascending">配件名称
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 177px;"
                            aria-label="Platform(s): activate to sort column ascending">配件价格
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 121px;"
                            aria-label="Engine version: activate to sort column ascending">配件分类
                        </th>
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 121px;" aria-label="Engine version: activate to sort column ascending">商品简介</th> -->
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 121px;" aria-label="Engine version: activate to sort column ascending">适用机型</th> -->
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 121px;"
                            aria-label="Engine version: activate to sort column ascending">配送区域
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 121px;"
                            aria-label="Engine version: activate to sort column ascending">库存数量
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 121px;"
                            aria-label="Engine version: activate to sort column ascending">评价等级
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                    ...
                    <?php if(is_array($fits)): foreach($fits as $key=>$vo): ?><tr class="<?php echo $key%2==0 ? " odd
                        " :"even"; ?>">
                        <td class=""><?php echo ($vo["id"]); ?></td>
                        <!-- 使用变量调节器来获取数据库内容 -->
                        <td class=""><?php echo ($vo["name"]); ?></td>
                        <td class=" "><?php echo ($vo["price"]); ?></td>
                        <td class=""><?php echo (getgoodscate($vo["cate"])); ?></td>
                        <!-- <td class=" "><?php echo ($vo["headline"]); ?></td> -->
                        <!-- <td class=" "><?php echo ($vo["fit"]); ?></td> -->
                        <td class=" "><?php echo (sendarea($vo["sendarea"])); ?></td>
                        <td class=" "><?php echo ($vo["amount"]); ?></td>
                        <td class=" "><?php echo ($vo["grade"]); ?></td>
                        <td class=" ">
                            <a class="btn btn-small" href="<?php echo U('Fit/edit',array('id'=>$vo['id']));?>"><i
                                    class="icon-pencil"></i></a>
                            <a class="btn btn-small" href="<?php echo U('Fit/delete',array('id'=>$vo['id']));?>"><i
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('select').change(function () {
                var num = $(this).val();
                $.get('/object/index.php/Admin/Fit/changeNum', {num: num}, function () {
                    location.href = '/object/index.php/Admin/Fit/index';
                });
            })
