...
<div id="mws-wrapper">
    ...
    <div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
            <form action="<?php echo U('Fitimg/insert');?>" class="mws-form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mws-form-item" style="width:600px;">
                            <select class="large" name="fid">
                                ...
                                <?php if(is_array($info)): foreach($info as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"
                                    <?php if(($vo['id']) == $fid): ?>selected="selected"<?php endif; ?>
                                    ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="mws-form-row">
                        <label class="mws-form-label">图显区图片</label>
                ...
                <div class="mws-button-row">
                    <input type="submit" class="btn btn-danger" value="点击上传,继续添加">
                    <input type="button" class="btn btn-danger" name="go" value="完成上传,回到列表">
                    <script type="text/javascript" src="/object/Public/js/libs/jquery-1.8.3.js"></script>
                    <script type="text/javascript">
                        //获取节点并绑定事件
                        $("input[name='go']").click(function () {
                            window.location.href = "<?php echo U('Fitimg/index');?>";
                        })
                    </script>
