...
<div id="mws-wrapper">
    ...
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span><i class="icon-table"></i>配件图显区图片列表</span>
        </div>
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <tr role="row">
                        <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            aria-label="Rendering engine: activate to sort column descending">配图ID
                        </th>
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            aria-label="Platform(s): activate to sort column ascending">配件图显区配图
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                    ...
                    <?php if(is_array($fitInfo)): foreach($fitInfo as $key=>$vo): ?><tr class="<?php echo $key%2==0 ? " odd
                        " :"even"; ?>">
                        <td class=""><?php echo ($vo["id"]); ?></td>
                        <!-- 使用变量调节器来获取数据库内容 -->
                        <td class=" "><?php echo ($vo["name"]); ?></td>
                        <td class=""><img src="/object<?php echo ($vo["img"]); ?>" alt="" style="width:150px;height:100px;"></td>
                        <td class=" ">
                            <a class="btn btn-small" href="<?php echo U('Fitimg/delete',array('id'=>$vo['id']));?>"><i
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('select').change(function () {
                var num = $(this).val();
                $.get('/object/index.php/Admin/Fitimg/changeNum', {num: num}, function () {
                    location.href = '/object/index.php/Admin/Fitimg/index';
                });
            })
