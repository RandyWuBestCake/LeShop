                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            aria-label="Browser: activate to sort column ascending">网址标题
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 177px;"
                            aria-label="Platform(s): activate to sort column ascending">网址地址
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 121px;"
                            aria-label="Engine version: activate to sort column ascending">是否显示
                        </th>

                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 87px;"
                            aria-label="CSS grade: activate to sort column ascending">显示顺序
                        </th>


                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 87px;"
                            aria-label="CSS grade: activate to sort column ascending">简介
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 87px;"
                    ...
                    <?php if(is_array($links)): foreach($links as $key=>$vo): ?><tr class="<?php echo $key%2==0 ? " odd
                        " :"even"; ?>">
                        ...
                        <td class=" ">
                            <?php if($vo['display'] == 0): ?>隐藏
                                <?php else: ?>
                                显示<?php endif; ?>
                        </td>
                        <td class=" "><?php echo ($vo['order']); ?></td>
                        <td class=" "><?php echo ($vo['intro']); ?></td>
                        <td>
                            <a class="btn btn-small" href="<?php echo U('Links/edit',array('id'=>$vo['id']));?>"><i
                                    class="icon-pencil"></i></a>
                            <a class="btn btn-small" href="<?php echo U('Links/delete',array('id'=>$vo['id']));?>"><i
