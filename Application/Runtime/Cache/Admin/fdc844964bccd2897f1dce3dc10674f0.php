...
<div id="mws-wrapper">
    ...
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span>修改回复 Store_goods_reply</span>
        </div>
        <div class="mws-panel-body no-padding">
            <form action="<?php echo U('Store:reply_save');?>" class="mws-form" method="post">
                <div class="mws-form-inline">
                    <div class="mws-form-row">
                        <label class="mws-form-label">内容</label>

                        <div class="mws-form-item">
                            <textarea name="con" cols="60"><?php echo ($row['con']); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mws-form-inline">
                    <div class="mws-form-row">
                        <label class="mws-form-label">评级</label>

                        <div class="mws-form-item">
                            <input type="text" class="medium" name="lever" value="<?php echo ($row['lever']); ?>">
                        </div>
                    </div>
                </div>
