    ...
    <div class="mws-panel grid_8 mws-collapsible">
        ...
        <div class="mws-panel-body no-padding">
            <table class="mws-table mws-datatable">
                ...
                <form action="<?php echo U('Spec/updete');?>" class="mws-form" method="post">
                    <?php if(is_array($spepr)): foreach($spepr as $k=>$vo): ?><tr>
                            ...
                            <?php if(is_array($vo)): foreach($vo as $key=>$l): ?><td><?php echo ($l['name']); ?></td>
                                <td><input type="text" class="small" name="<?php echo ($l['id']); ?>" value="<?php echo ($l['con']); ?>"></td>
                        </tr><?php endforeach; endif; endforeach; endif; ?>
                    <tr>
                        <td></td>
                        <td></td>
                        <td style="margin-right:10px">
                            <!-- <input type="hidden" name="pscid" value="<?php echo I('get.id');?>"> -->
