...
<div id="mws-wrapper">
    ...
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span><i class="icon-table"></i>优惠活动</span>
        </div>
        <div class="mws-panel-body no-padding">
            <table class="mws-table">
                ...
                <?php if(is_array($rows)): foreach($rows as $key=>$vo): ?><tr>
                        ...
                        <td><?php echo date('Y-m-d',$vo['expire_time']);?></td>
                        <td><a style="color:#444" href="<?php echo U('Coupon:edit',array('id'=>$vo['id']));?>">修改</a> || <a
                                style="color:#444" href="<?php echo U('Coupon:manage',array('id'=>$vo['id']));?>">管理优惠卷</a> || ||
                            <a style="color:#444" href="<?php echo U('Coupon:create',array('id'=>$vo['id']));?>">生成优惠卷</a> ||<a
                                    style="color:#444" href="<?php echo U('Coupon:del',array('id'=>$vo['id']));?>">删除活动</a></td>
