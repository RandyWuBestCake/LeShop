...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form action="<?php echo U('Fit/update');?>" class="mws-form" method="post" enctype="multipart/form-data">
        <div class="mws-form-inline">
        <div class="mws-form-row">
                    <label class="mws-form-label">配件ID</label>
                    <div class="mws-form-item">
                        <!-- <span>※</span> -->
                        <input type="text" class="small" name='id' value="<?php echo ($fitInfo["id"]); ?>" readonly>
                    </div>
        </div>
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item" style="width:600px;">
                        <select class="large" name='cate'>
                            ...
                            <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo['id']) == $fitInfo['cate']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                </div> 
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <!-- <span>※</span> -->
                        <input type="text" class="small" name='name' value="<?php echo ($fitInfo["name"]); ?>">
                    </div>
                </div>
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                    <!-- <span>※</span> -->
                        <input type="text" class="small" name='price' value="<?php echo ($fitInfo["price"]); ?>">
                    </div>
                </div>
...
<!--                 <div class="mws-form-row">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                      <input type="text" class="small" name='headline' value="<?php echo ($fitInfo["headline"]); ?>">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">适用机型</label>
                    <div class="mws-form-item">
                        <input type="text" class="small" name='fit' value="<?php echo ($fitInfo["fit"]); ?>">
                    </div>
                </div>
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item" style="width:600px;">
                        <select class="large" name="sendarea">
                            <option value="0">请选择</option>
                            <?php if(is_array($province)): foreach($province as $k=>$vo): ?><option value="<?php echo ($fitInfo["sendarea"]); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                </div> 
                <!-- <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="small" name='amount' value="<?php echo ($fitInfo["amount"]); ?>">
                    </div>
                </div> -->
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item" style="width:600px;">
                        <select class="large" name="grade">
                            ...
                            <option value="5" selected>5星级</option>
                        </select>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <img src="/object<?php echo ($fitInfo["img"]); ?>" alt="" style="width:150px;height:100px;">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                    <script id="editor" type="text/plain" style="width:1024px;height:500px;" name="desc"><?php echo ($fitInfo["desc"]); ?></script>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                    <script id="editor_param" type="text/plain" style="width:1024px;height:500px;" name="param"><?php echo ($fitInfo["param"]); ?></script>
                    <script type="text/javascript">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="small Wdate" name="addtime" onClick="WdatePicker()" value="<?php echo (date("y-m-d",$fitInfo["addtime"])); ?>">
                    </div>
                </div> 
        </div>
