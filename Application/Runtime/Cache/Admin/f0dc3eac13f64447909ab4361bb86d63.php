                ...
                <div>
                    <table class="mws-table">
                        ...
                        <?php if(is_array($rows)): foreach($rows as $key=>$v): ?><tr>
                                ...
                                <td><img width="60px" src="/object/Public/uploads/<?php echo ($v['img']); ?>"></td>
                                <td><?php echo ($v['author']); ?></td>
                                <td><?php echo ($v['version']); ?></td>
                                <td><?php echo ($v['cid']?$cates[$v['cid']]:"--"); ?></td>
                                <td><a style="color:#444"
                                       href="<?php echo U('Store:edit',array('id'=>$v['id'],'cid'=>$v['cid']));?>">修改</a> || <a
                                        style="color:#444" href="<?php echo U('Store:dodel',array('id'=>$v['id']));?>">删除</a> || <a
                                        style="color:#444" href="<?php echo U('Store:reply',array('id'=>$v['id']));?>">回复管理</a>
                                </td>
