...
<div id="mws-wrapper">
    ...
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span>操作设备管理 Control_device</span>
        </div>
        <div class="mws-panel-body no-padding">
            <form action="<?php echo U('Store:cd_doadd');?>" class="mws-form" method="post" enctype=multipart/form-data>
                <div class="mws-form-inline">
                    <div class="mws-form-row">
                        <label class="mws-form-label">设备名称</label>
                ...
                <div class="mws-form-inline">
                    <div class="mws-form-row">
                        <label class="mws-form-label">设备图标</label>

                        <div class="mws-form-item medium small">
                            <input type="file" class="medium" name="icon"> 推荐大小25X25px
                        </div>
                    </div>
                </div>
        ...
        <div class="mws-panel-body no-padding">
            <table class="mws-table">
                ...
                <?php if($name != '0'): if(is_array($rows)): foreach($rows as $key=>$vo): ?><tr>
                            ...
                            <td><img width="100px" src="/object/Public/Uploads/<?php echo ($vo['icon']); ?>"></td>
                            <td><a style="color:#444" href="<?php echo U('Store:cd_edit',array('id'=>$vo['id']));?>">修改</a> || <a
                                    style="color:#444" href="<?php echo U('Store:cd_dodel',array('id'=>$vo['id']));?>">删除</a></td>
