                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            aria-label="Browser: activate to sort column ascending">父级分类
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            aria-label="Engine version: activate to sort column ascending">硬件全配价格
                        </th>
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 121px;" aria-label="Engine version: activate to sort column ascending">硬件价格所属</th> -->
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" style="width: 121px;"
                            aria-label="Engine version: activate to sort column ascending">乐视网TV版服务费
                        </th>
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 121px;" aria-label="Engine version: activate to sort column ascending">服务有效期</th> -->
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 121px;" aria-label="Engine version: activate to sort column ascending">增配包价格</th> -->
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 121px;" aria-label="Engine version: activate to sort column ascending">硬件全配价格</th> -->
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 121px;" aria-label="Engine version: activate to sort column ascending">增配价格描述</th> -->
                        <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 121px;" aria-label="Engine version: activate to sort column ascending">添加时间</th> -->
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                    ...
                    <?php if(is_array($goodsInfo)): foreach($goodsInfo as $key=>$vo): ?><tr class="<?php echo $key%2==0 ? " odd
                        " :"even"; ?>">
                        <td class=""><?php echo ($vo["id"]); ?></td>
                        <!-- 使用变量调节器来获取数据库内容 -->
                        <td class=""><?php echo (getgoodscate($vo["pid"])); ?></td>
                        <td class=""><?php echo ($vo["name"]); ?></td>
                        <td class=" "><?php echo ($vo["hwprice"]); ?></td>
                        <!-- <td class=" "><?php echo ($vo["hw"]); ?></td> -->
                        <td class=" "><?php echo ($vo["servicebagprice"]); ?></td>
                        <!-- <td class=" "><?php echo ($vo["expiry"]); ?></td> -->
                        <!-- <td class=" "><?php echo ($vo["servicebagprice"]); ?></td> -->
                        <!-- <td class=" "><?php echo ($vo["servicebag"]); ?></td> -->
                        <!-- <td class=" "><?php echo date('Y-m-d',$vo['addtime']); ?></td> -->
                        <td class=" ">
                            <a class="btn btn-small" href="<?php echo U('Goods/edit',array('id'=>$vo['id']));?>"><i
                                    class="icon-pencil"></i></a>
                            <a class="btn btn-small" href="<?php echo U('Goods/delete',array('id'=>$vo['id']));?>"><i
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('select').change(function () {
                var num = $(this).val();
                $.get('/object/index.php/Admin/Goods/changeNum', {num: num}, function () {
                    location.href = '/object/index.php/Admin/Goods/index';
                });
            })
