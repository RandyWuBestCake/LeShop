...
<body>         <div class="main">	<div class="page_location">        <!--<div class="location"><span id="positionUrl"></span></div>-->		<div class="location">			<a class="bailist_lo" href="/wenwen">        <?php echo ($c[$arts['cid']]); ?></a>&nbsp;>&nbsp;<a href="/wenwen/qa/1" ><?php echo ($arts['title']); ?></a>        		</div>    </div>    <div class="clearfix"></div>	<div class="view_wraps">		<div class="view_content">			<div class="title_box">				<div class="title"style="color: #0099bb;float:left" >[<?php echo ($c[$arts['cid']]); ?>]</div>        <h1><?php echo ($arts['title']); ?></h1>			<div class="info">				<div class="info_tips">					<div class="baiinfoleft">						<span class="icon_bg icon_view bai">浏览次数：<?php echo ($arts['acount']); ?></span>						<span class="line"></span>						<span><?php echo date('Y-m-d',$arts['create_time']);?></span>					</div>                </div>			</div>	</div>	<!--分页导航开始-->	 <!--分页导航结束-->	<div class="content"><?php echo ($arts['con']); ?></div>		<!-- <div class="zhichi" onclick="isUseful(1502,0)" id="iuseful2_1502">认为此文章有用就支持一下！</div>		<div class="zhichi y" style="display:none">xxx人认为此文章有用</div> -->	<!--分页导航开始-->	 <!--分页导航结束-->    </div>	<div class="bdetail_zandiv">			<div class="dianzan d" onclick="isUseful(1502,0)" id="iuseful2_1502">点赞</div>			<div class="pingluns">收起评论</div>	</div>			<!-- 评论开始 -->	<a name="comment_list" id="comments"></a>	<div id="commentsLoadDiv"></div>	<!-- 评论结束 --></div>    <div class="right_box">    	<div class="right_user">        	<div class="pic"><a></a><!--<a href="/wenwen/user/15.html"></a>--><img src="/object/Public/images/Picture/user_face.gif" width="154" height="154" /></div>            <div class="nickname">					<span class="names"   >小乐3</span><br /><span>乐视技术专家</span>					<span class="le_m"></span>				</div>            <!--<div class="btn" onclick="loadSendQuestForm('sendQuestionForm',987654321,1)"><a href="javascript:;">向TA提问</a></div>-->        </div>		<!--他的问一问 Start-->    	<div class="box">        	<div class="title">他的文章</div>            <ul class="list_type1">				<?php if(is_array($bn)): foreach($bn as $key=>$vo): ?><li><span class="mark" style="color:#256bbb">·</span><a style=" color:#256bbb;" href="<?php echo U('Article/xiangqing',array('id'=>$vo['id']));?>" target="_blank"><?php echo ($vo['title']); ?></a></li><?php endforeach; endif; ?>				</ul>        </div>		<!--他的问一问 End-->				<!--相关问一问 Start-->		<div class="box">        	<div class="title">相关文章</div>            <ul class="list_type1">				<?php if(is_array($bn2)): foreach($bn2 as $key=>$vo): ?><li><span class="mark" style="color:#666">·</span><a style=" color:#666;" href="<?php echo U('Article/xiangqing',array('id'=>$vo['id']));?>" target="_blank"><?php echo ($vo['title']); ?></a></li><?php endforeach; endif; ?>				</ul>        </div>		<!--相关问一问 End-->		        <!-- 右侧广告 Start-->		<div class="ad">        	<ul>            	<li><a href="javascript:void(0)" target="_blank" onclick="getAdvertisUrl(1199,'http://bbs.letv.com/thread-458916-1.html')"><img src="/object/Public/images/Picture/201501151418206799200.jpg" width="250" /></a></li>            	<li><a href="javascript:void(0)" target="_blank" onclick="getAdvertisUrl(1200,'http://shop.letv.com/product/lexiaobao.html')"><img src="/object/Public/images/Picture/201501151411434463500.jpg" width="250" /></a></li>            </ul>        </div> 		<!--右侧广告 End-->    </div>    <div class="clearfix"></div>    <div class="blank80"></div></div>
