...
<head>
  ...
  <![endif]-->
    ...
    <link type='text/css' href='/object/Public/css/Content/global.css?v=20150115' rel='stylesheet'/>
    <link type='text/css' href='/object/Public/css/fonts/icomoon/style.css' rel='stylesheet'/>
    <!--<script type='text/javascript' src='/object/Public/js/Scripts/generateSession.js?v=20140616'></script>-->
    <script type='text/javascript' src='/object/Public/js/jquery-1.8.3.min.js?v=20140616'></script>
    <!--<script type='text/javascript' src='/object/Public/js/Scripts/zxlib.js?v=20141106'></script>-->
    <!--<script type='text/javascript' src='/object/Public/js/Scripts/template.js?v=20140221'></script>-->
    <link type='text/css' href='/object/Public/css/Content/user.css?v=20141121' rel='stylesheet'/>
    <!--<script type='text/javascript' src='/object/Public/js/Scripts/usercenterAddr.js?v=20141215'></script>-->
    <script>
        var addres_url = ' <?php echo U("Account/addressAjax");?>';
        var ssq = ' <?php echo U("Account/ssqAjax");?>';
        var dodel_url = ' <?php echo U("Account/dodel");?>';
    </script>
...
<body>
  ...
  <?php  $rNav = getNav(1); $lNav = getNav(0); ?>
    ...
    <div class="main_body center">
        ...
        <div class="user_category_new left f8_bg pb20">
            <dl>
                ...
                <dd>
                    <a href="<?php echo U("Account/order");?>" target="_self">
            ...
            <dl>
                ...
                <dd>
                    <a href="<?php echo U('Account:personalInfo');?>" target="_self">
                        <span class="font14">个人信息</span>
                    </a>
                </dd>
                <dd>
                    <a class="on" href="<?php echo U('Account:address');?>" target="_self">
                        <span class="font14">收货地址</span>
                    </a>
                </dd>
                <dd>
                    <a href="<?php echo U('Account:coupons');?>" target="_self">
        ...
        <div>
            <div class="user_main right">
                ...
                <div style="overflow: hidden; width: 300px; margin: 0px auto; display: none;" id="div_loading">
                    <br>
                    <img src="/object/Public/css/Images/loading.gif" style="float:left; display:inline;"><span
                ...
                <div class="user_order_list">
                    <div id="div_order_list" style="display: block;">
                        <?php if(is_array($rows)): foreach($rows as $k=>$vo): ?><table width="100%" cellspacing="1" cellpadding="0" border="0" style="background:#dfdfdf;"  class="mb10">
                            <tbody>
                            <tr>
                                <th class="order_list_title f8_bg pl20 pr20" colspan="4">
                                    ...
                                    <div class="left font14 dark">普通订单：<a
                                            href="#"><span
                                            class="dark"><?php echo ($vo['order_num']); ?>
			</span></a></div>
                                    <div class="left font14 gray"><span class="pl20 pr20">|</span><span><?php echo date("Y-m-d H:i:s",$vo['order_time']);?></span>
                                    </div>
                                    <div class="clear"></div>
                                </th>
                            </tr>
                                    ...
                                    <ul class="pl20">
                                        ...
                                        <li class="relativeList">
                                            <div class="order_list_picImg"><a target="_blank"
                                                                              href="<?php echo U('Home/Fit/detail',array('id'=>$vo['goods_id']));?>"><img  style="width:80px;"
                                                    src="/object/<?php echo ($grows[$k]['img']); ?>"
                                                    title="<?php echo ($grows[$k]['name']); ?>" alt="<?php echo ($grows[$k]['name']); ?>"></a></div>
                                            <div target="_blank"
                                                 onclick="window.location.href='<?php echo U('Home/Fit/detail',array('id'=>$vo['goods_id']));?>'"
                                                 class="order_list_picDetail border white_bg pt15 pb15 hand">
                                                <div title="<?php echo ($grows[$k]['name']); ?>" class="title">
                                                    <div class="tit"><?php echo ($grows[$k]['name']); ?></div>
                                                </div>
                                                <div class="price"><span class="red font14">¥<?php echo ($vo['unit_price']); ?> </span>
				...
				1
                                ...
                                <td valign="top" align="left" class="order_list_item1 white_bg">
                                    <div class="font14 dark">¥<?php echo ($vo['unit_price']); ?></div>
                                    <div title="<?php echo ($_SESSION['users']['username']); ?>" class="font14 dark"><?php echo ($_SESSION['users']['username']); ?></div>
                                    <div order-data="<?php echo ($vo['order_num']); ?>" id="order_address_<?php echo ($vo['order_num']); ?>"
                                         class="address font14 dark hand">
                                        <?php $arr = explode(',',$urows[$k]['addressid']); echo (getaddress($arr[0])); echo (getaddress($arr[1])); echo (getaddress($arr[2])); ?>，<?php echo ($urows[$k]["address"]); ?>
                                        <span class="more"></span>

                                        <div style="top:25px; right:30px;" id="addressInfo_div_<?php echo ($vo['order_num']); ?>"
                                             class=" white_bg addressInfoDiv hidden">
                                            <div class="hidden border white_bg address_popup"
                                                 id="div_loading_address<?php echo ($vo['order_num']); ?>">
                                                <div class="t_c pt5"><img src="/object/Public/css/Images/loading.gif"
                                ...
                                <td valign="top" align="center" class="order_list_item2 t_c white_bg">
                                    <div class="font14 dark pb10"><?php echo ($status[$vo['order_status']]); ?></div>
                                    <div order-data="<?php echo ($vo['order_num']); ?>" id="showDelieverInfo_<?php echo ($vo['order_num']); ?>" class="mode">
                                ...
                                <td valign="top" align="center" class="order_list_item3 t_c white_bg">
                                        ...
                                        <div class="fk_button  pb10">
                                            ...
                                            <div>
                                                <a class="block_center gray_bt_m" target="_blank"
                                                   href="<?php echo U('Home/Fit/detail',array('id'=>$vo['goods_id']));?>"><span
                                    ...
                                    <div class="font14 pb5">
                                        <a target="_blank"   href="<?php echo U('Home/Fit/detail',array('id'=>$vo['goods_id']));?>">
                                        <span  class="blue">订单详情</span>
                                        </a>
                                    </div>
                                    <div class="font14 pb5">
                                        <a target="_blank"   href="<?php echo U('Home/Fit/addcomment',array('id'=>$vo['goods_id'],'order_num'=>$vo['order_num']));?>">
    ...
    <script type='text/javascript' src='/object/Public/js/Scripts/userAddress.js'></script>
    <script>
