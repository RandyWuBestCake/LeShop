...
<head>
  ...
  <![endif]-->
    ...
    <!-- <link type='text/css' href='/object/Public/css/mws-theme.css' rel='stylesheet'/> -->
    <link type='text/css' href='/object/Public/bootstrap/css/bootstrap.min.css' rel='stylesheet'/>
    <link type='text/css' href='/object/Public/css/mws-style.css' rel='stylesheet'/>
...
<body>
  ...
  <?php  $rNav = getNav(1); $lNav = getNav(0); ?>
        ...
        <div>
            <div id="content" class="user_main right">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-ok"></i> 个人信息</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="<?php echo U('Account/editPersonalInfo');?>" method="post"  enctype="multipart/form-data">
                            <div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">用户名</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="required large" disabled value="<?php echo ($row['username']); ?>">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">用户昵称</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="nickname" class="required large" value="<?php echo ($row['nickname']); ?>">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">性别</label>
                                    <div class="mws-form-item">
                                           <input type="radio" name="sex" class="required" value='1' <?php echo ($row['sex']?'checked="checked"':''); ?>> <label for="gender_male">男</label>
                                            <input id="gender_female" type="radio" name="sex" value='0' <?php echo ($row['sex']?'':'checked="checked"'); ?>> <label for="gender_female">女</label>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Email</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="email" class="required email large" value="<?php echo ($row['email']); ?>">
                                    </div>
                                </div>
                            <!--     <div class="mws-form-row">
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" name="tel" value = "<?php echo ($row['tel']); ?>" class="required tel large">
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        ...
                                        <br />
                                        <img src="/object/<?php echo ($row['img']); ?>" width="80px;" alt="">
                                    </div>
                                </div>
                            </div>
    ...
    <script type='text/javascript' src='/object/Public/bootstrap/js/bootstrap.min.js'></script>
    <script type='text/javascript' src='/object/Public/plugins/validate/jquery.validate.js'></script>
    <script type='text/javascript' src='/object/Public/js/demo/demo.formelements.js'></script>
