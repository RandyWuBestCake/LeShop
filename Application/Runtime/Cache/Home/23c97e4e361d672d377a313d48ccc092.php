...
<!-- 导航  首页 时光轴 热播 --><div class="main1">  <div class="snav_box">    <div class="bj_btn" onClick="window.open('http://zhifu.letv.com/tobuy/pro')"></div>      <ul class="nav_li">        <li ><a href="<?php echo U('Look/index');?>" >首页</a></li>        <li class="cur"><a href="<?php echo U('Look/timeline');?>" class="current">时光轴</a></li>        <li><a href="<?php echo U('Look/hot');?>">热播精选</a></li>      </ul>  </div></div><div class="clearfix"></div><div class="blank71"></div><!-- 精选剧目 --><div class="page_title" style="padding-top:20px;">精选剧目</div><div class="main2">  <div class="hot_movie">    <div class="movie_list">    <ul>    <?php if(is_array($arts)): foreach($arts as $key=>$vo): ?><li style="width:234px">        <div class="box">          <div class="pic_infos">            <div class="img">              <a href="<?php echo U('Look/xiangqing',array('id'=>$vo['id']));?>" target="_blank">                <img src="/object<?php echo ($vo['img']); ?>" width="230" height="220" />              </a>            </div>            <div class="infos">              <a class="title" href="<?php echo U('Look/xiangqing',array('id'=>$vo['id']));?>" target="_blank"><?php echo ($vo['title']); ?></a>            </div>          </div>          <div class="option">                         </div>          <div class="user_infos">            <div class="info none">暂时没有评论哦~</div>          </div>        </div>      </li><?php endforeach; endif; ?>      <div class="clearfix"></div>    </ul>    </div>  </div></div><!-- 大家都在看 --><div class="page_title">大家都在看</div>  <div class="look_list">    <ul>      <?php if(is_array($num)): foreach($num as $k=>$v): ?><li>        <div class="title">          <span class=link>            <span class="no" >No.<?php echo ($k+1); ?>　　</span>            <a href="<?php echo U('Look/xiangqing',array('id'=>$v['id']));?>" class="tles" target="_blank"><?php echo ($v['title']); ?></a>          </span>          <a  href="javascript:void(0)" onclick="isUseful(1302,0)"  class="good">            <span id="iuseful_1302">赞</span>          </a>        </div>        <div class="box">            <div class="pic">              <img src="/object<?php echo ($v['img']); ?>" width="210" height="288" />            </div>            <div class="infos">              <div class="info">              <?php echo ($v['con']); ?>              </div>            </div>        </div>      </li><?php endforeach; endif; ?>    </ul>  </div><!-- 热播排行 --><div class="page_title2"><a name="rebo" id="rebo"></a>热播排行</div><div class="main2" style="padding-bottom:50px;">  <?php if(is_array($rank)): foreach($rank as $key=>$vo): ?><div class="hot_rank"  style="width:200px">      <div class="title"><?php echo ($t[$v['tags']]); ?></div>        <ul>        <?php if(is_array($vo)): foreach($vo as $k=>$v): ?><li><em class="num num<?php echo ($k+1); ?>"><?php echo ($k+1); ?></em><a href="<?php echo U('Look/xiangqing',array('id'=>$v['id']));?>" webtrekkparam="{ct:'xbsy_lswTVb4K_1'}"><?php echo ($v['title']); ?></a></li><?php endforeach; endif; ?>	        </ul>    </div><?php endforeach; endif; ?>  <div class="clearfix"></div></div>
