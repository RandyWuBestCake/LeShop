        ...
        <div>
            <div id="content" class="user_main right">
                ...
                <div class="user_main right mt50" style="text-align: center; display: none;" id="loading">
                    <img src="/object/Public/images/Images/loading.gif"><br>
                    加载中，请稍等...
                </div>
                <!--  新增地址模块  -->
                <div class="user_addr_new pt20 pb20">
                    ...
                    <div id="addressCount" class="hidden" style="display: block;">
                        <div class="tit">
                            ...
                            <div style="_padding-top:3px;" class="left pl20 font14">您已创建<span id="num" class="red"><?php echo count($row);?></span>个收货地址，最多可创建<span
                                    class="red">5</span>个
                            </div>
                            <div class="clear"></div>
                        </div>
                ...
                <div id="userAddressList" class="user_addr_list">
                    <?php if(is_array($row)): foreach($row as $key=>$vo): ?><li id="addrInfo_<?php echo ($vo['id']); ?>" class=" display-address border yjg addrInfo_li"
                                ...
                                <div class="right">
                                    <div class="right pl10 t_c close"><!--只需要加上hover“x”就会变成删除-->
                                        ...
                                        <a data-addrid="2378659" class="delete"
                                           href="javascript:dodel(<?php echo ($vo['id']); ?>)"><span
                                                class="red">删除</span></a>
                                    </div>
                                ...
                                <div class="addr_info_left pl20 pr30 font14 left">
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" width="78%" valign="top"><?php echo ($vo['name']); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" valign="top">地址：</td>
                                            <td align="left" valign="top" title="<?php echo ($vo['address']); ?>"><?php echo ($vo['address']); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" valign="top">手机：</td>
                                            <td align="left" valign="top"><?php echo ($vo['mobile_phone']); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" valign="top">固定电话：</td>
                                            <td align="left" valign="top"><?php echo ($vo['fix_phone']); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" valign="top">邮编：</td>
                                            <td align="left" valign="top"><?php echo ($vo['postal_code']); ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="addr_operate pb20">
                                <div class="addr_operate_left pl20 pr30 font14 left t_r">
                                    <span onclick="editUserAddrInfo(<?php echo ($vo['id']); ?>)" class="blue hand">编辑地址</span>
                                </div>
                                <div class="addr_operate_right pl30 pr20 font14 right t_r">
                                    <a onclick="upToYjgAddr(<?php echo ($vo['id']); ?>)" href="javascript:void('0')"><span
